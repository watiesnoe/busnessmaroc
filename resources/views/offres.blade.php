...
@section('content')
    ...
    <style>
        ...
        .bg-offres::before {
            ...
            background: rgba(0, 0, 0, 0.5); /* assombrit pour améliorer la lisibilité */
            z-index: 1;
        }
    ...
    <section class="section-box-2 d-flex align-items-center position-relative text-white"
        ...
        <div class="container position-relative" style="z-index: 2;">
            <div class="p-4 text-center offre-card-content">
                ...
                <p class="lead mt-2">Explorez les meilleures opportunités de carrière près de chez vous ou à distance.</p>
            </div>
        </div>
    </section>
    </div>
    ...
    <section class="section-box mt-50">
        <div class="section-box wow animate__animated animate__fadeIn">
            <div class="container-fluid" style="padding-left: 30px; padding-right: 30px;">
                <div class="row flex-row-reverse mx-auto" style="max-width: 85%;">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                        <div class="card shadow rounded p-3  mt-3 h-auto">
                            <h5 class="bg-primary text-white text-center py-2 rounded">Secteurs d'activité</h5>
                            <div class="mt-3">
                                <ul class="list-unstyled">
                                    @php
