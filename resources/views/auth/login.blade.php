            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card shadow-lg border-0 rounded-4 p-4 bg-white">
                        <h3 class="text-center mb-4" style="color: #d50100;">Connexion</h3>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="{{ route('password.request') }}" class="text-decoration-none"
                                    style="color: #d50100;">Mot de passe oublié ?</a>
                            </div>

                            <div class="d-grid mb-3">
                                <button type="submit" class="btn" style="background-color: #d50100; color: #fff;">Se
                                    connecter</button>
                            </div>

                            <div class="text-center">
                                <span class="text-muted">Pas encore de compte ?</span>
                                <a href="{{ route('register.client') }}" class="text-decoration-none"
                                    style="color: #d50100;">Créer un compte</a>
                            </div>
                        </form>
                    </div>
                </div>
