...
<div class="row g-4">
    @forelse($offres as $offre)
        <div class="col-md-12">
            ...
            <a href="{{ route('details_offre.show', $offre->id) }}" class="text-decoration-none text-dark">
                <div class="card shadow-sm border-0 rounded-4 overflow-hidden h-100">
                    ...
                    <div class="card-body text-dark d-flex flex-column">
                        ...
                        <!-- Bouton optionnel : on peut le garder ou le retirer car la carte est déjà cliquable -->
                        <div class="mt-auto text-end">
                            <span class="btn px-4 py-2"
                                  style="background: linear-gradient(135deg, #d50100, #ff4d4d); color:white; font-weight:600; border-radius: 8px;">
                                Plus de détails
                            </span>
                        </div>
