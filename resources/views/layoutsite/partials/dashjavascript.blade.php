    ...
    <script src="{{ asset('asset/js/plugins/wow.js') }}"></script>
    ...
    <script src="{{ asset('asset/js/plugins/isotope.js') }}"></script>
    <script src="{{ asset('asset/js/plugins/scrollup.js') }}"></script>
