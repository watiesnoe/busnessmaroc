            ...
            <div class="col-lg-8">
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">{{ isset($actualite) ? 'Modifier l\'actualité' : 'Créer une nouvelle actualité' }}</h3>
                    </div>
                    <div class="block-content block-content-full">
                        ...
                        <form id="formActualite"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="contenu" class="form-control" id="contenu" rows="4" required>{{ old('contenu', $actualite->contenu ?? '') }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="date_publication" class="form-control" id="date_publication"
                            ...
                            <div class="mb-3">
                                ...
                                <div id="preview-container" class="mt-3 text-center">
                                    @if(isset($actualite) && $actualite->image)
                                        <img src="{{ asset('storage/'.$actualite->image) }}" class="img-fluid mt-3 rounded shadow" style="max-height:250px;">
                                    @else
            ...
            <div class="col-lg-4">
                <div class="block block-rounded">
                    ...
                    <div class="block-content text-center">
                        ...
                        <p class="text-muted">L’image sélectionnée apparaîtra ici.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            $('#image').on('change', function() {
                ...
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $('#preview-container').html('<img src="'+e.target.result+'" class="img-fluid mt-3 rounded shadow" style="max-height:250px;">');
                    }
