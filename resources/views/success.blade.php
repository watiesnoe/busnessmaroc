            ...
            <div class="card shadow-sm border-0 rounded-4">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <!-- Entreprise (select dynamique) -->
                        <div class="col-md-4">
                            <label class="form-label">Entreprise</label>
                            <select name="entreprise_id" class="form-select shadow-sm" required>
...
@section('scripts')
    <script>
        // Affiche le champ salaire seulement pour "emploi"
        document.getElementById('type_offre').addEventListener('change', function () {
            ...
            salaireField.style.display = this.value === 'emploi' ? 'block' : 'none';
        });
    </script>
@endsection
