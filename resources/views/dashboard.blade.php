    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="mb-4 text-center">
                <h2 class="fw-bold text-primary mb-2">Location par Chambre</h2>
                <p class="text-muted">Découvrez nos offres de chambres à louer — confortables, pratiques et bien situées.
                </p>
            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div class="ratio ratio-4x3">
                                    <img src="{{ asset('storage/' . ($immobi->photos->first()->url ?? 'default.jpg')) }}"
                                         class="card-img-top object-fit-cover" alt="Image chambre">
                                </div>

                                {{-- Corps du card --}}
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <h5 class="card-title text-dark">{{ $immobi->titre }}</h5>
                                    <p class="text-muted mb-1"><i class="bi bi-geo-alt"></i> {{ $immobi->ville }},
                                        {{ $immobi->quartier }}</p>
                                    <p class="mb-2"><strong>{{ $immobi->prix }} FCFA</strong> / mois</p>

                                    {{-- Bouton + Type --}}
                                    <div class="d-flex justify-content-between align-items-center mt-auto">
                                        <span
                                            class="badge bg-primary text-light">{{ ucfirst($immobi->category->nom) }}</span>
    ...
    <section class="section-box mt-50 mb-50">
        <div class="container">
            ...
            <div class="text-start mb-4">
                <h2 class="section-title fw-bold wow animate__animated animate__fadeInUp">Actualités & Conseils</h2>
                <p class="font-lg text-muted wow animate__animated animate__fadeInUp" style="max-width: 600px;">
